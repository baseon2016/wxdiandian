...
Page({
    ...
    openActionSheet: function() {
        ...
        o && (a > 0 ? e > 0 ? wx.redirectTo({
          url: "/pages/creditshop/create/index?id=" + t.data.goods.id + "&optionid=" + e + "&merchid=" + t.data.goods.merchid
        }) : t.optionclick() : wx.redirectTo({
            url: "/pages/creditshop/create/index?id=" + t.data.goods.id + "&merchid=" + t.data.goods.merchid
        }));
    },
    onShow: function() {
        var o = this;
